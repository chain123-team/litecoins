...
allowing somebody to distribute a Bitcoin-Qt.app or ltsoin-qt-setup.exe with a valid
...
that the ltsoin-qt.exe file inside the installer had not been tampered with.
