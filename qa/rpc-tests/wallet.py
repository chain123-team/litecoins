...
#   c) node1 mines 32 blocks, so now node 0 has 500000LTS, node 1 has 4250LTS, node2 has none.
#   d) node0 sends 601 LTS to node2, in two transactions (301 LTS, then 300 LTS).
