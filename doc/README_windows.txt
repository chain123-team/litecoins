...
Intro
-----
LiteCoins (LTS) is a sustainable cryptocurrency modeled after
...
high-powered mining hardware. LiteCoins utilizes an energy efficient proof-of-stake algorithm,
...
Setup
-----
Unpack the files into a directory and run litecoins-qt.exe.

LiteCoins Core is the original LiteCoins client and it builds the backbone of the network.
However, it downloads and stores the entire history of LiteCoins transactions;
