The following is a list of assets used in the ltsoin source and their proper attribution.
...
* License: MIT
* Site: [https://ltsointalk.org/index.php?topic=15276.0](https://ltsointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original ltsoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/ltsoin.icns, src/qt/res/src/ltsoin.svg,
	src/qt/res/src/ltsoin.ico, src/qt/res/src/ltsoin.png,
	src/qt/res/src/ltsoin_testnet.png, docs/ltsoin_logo_doxygen.png,
