Contributing to LiteCoins Core
==================================

The LiteCoins Core project operates an open contributor model where anyone is
...
The following applies to code changes to the LiteCoins Core project, and is not to be
confused with overall LiteCoins Network Protocol consensus changes.

Whether a pull request is merged into LiteCoins Core rests with the project merge
...
Patches that change LiteCoins consensus rules are considerably more involved than
...
Where a patch set proposes to change the LiteCoins consensus, it must have been
...
The project leader is the release manager for each LiteCoins Core release.
