...
#ifndef LTSOIN_KEYSTORE_H
#define LTSOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/ltsoin/bips/blob/master/bip-0013.mediawiki
