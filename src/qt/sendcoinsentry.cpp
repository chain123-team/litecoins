                                                  ...
                                                  model(0)
{
    ...
    // normal lts address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying lts address(es)
    ui->payTo_is->setFont(GUIUtil::ltsoinAddressFont());
...
void SendCoinsEntry::clear()
{
    ...
    // update the display unit, to not use the default ("LTS")
    updateDisplayUnit();
}
