...
#ifndef LTSOIN_QT_LTSOINUNITS_H
#define LTSOIN_QT_LTSOINUNITS_H
...
/** LTS unit definitions. Encapsulates parsing and formatting
...
public:
    ...
    /** LTS units.
      @note Source: https://en.ltsoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit {
        LTS,
        mLTS,
