...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        intro.setWindowIcon(QIcon(":icons/ltsoin"));
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("LiteCoins Core"),
     ...
     * override -datadir in the litecoins.conf file in the default data directory
     * (to be consistent with litecoinsd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
