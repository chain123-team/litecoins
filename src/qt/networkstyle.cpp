...
static const struct {
    ...
    {"main", QAPP_APP_NAME_DEFAULT, ":/icons/ltsoin", "", ":/images/splash"},
    {"test", QAPP_APP_NAME_TESTNET, ":/icons/ltsoin_testnet", QT_TRANSLATE_NOOP("SplashScreen", "[testnet]"), ":/images/splash_testnet"},
    {"regtest", QAPP_APP_NAME_TESTNET, ":/icons/ltsoin_testnet", "[regtest]", ":/images/splash_testnet"}};
