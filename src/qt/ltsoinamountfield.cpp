...
public:
    ...
    QSize minimumSizeHint() const
    {
        if (cachedMinimumSizeHint.isEmpty()) {
            ...
            int w = fm.width(BitcoinUnits::format(BitcoinUnits::LTS, BitcoinUnits::maxMoney(), false, BitcoinUnits::separatorAlways));
