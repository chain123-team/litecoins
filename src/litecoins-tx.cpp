...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("LiteCoins Core litecoins-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  litecoins-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded litecoins transaction") + "\n" +
                               "  litecoins-tx [options] -create [commands]   " + _("Create hex-encoded litecoins transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded litecoins transaction
