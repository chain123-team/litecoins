...
{
    BOOST_CHECK(TestSplitHost("www.ltsoin.org", "www.ltsoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.ltsoin.org]", "www.ltsoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.ltsoin.org:80", "www.ltsoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.ltsoin.org]:80", "www.ltsoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:11888", "127.0.0.1", 11888));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:11888", "127.0.0.1", 11888));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:11888", "::ffff:127.0.0.1", 11888));
    BOOST_CHECK(TestSplitHost("[::]:11888", "::", 11888));
    BOOST_CHECK(TestSplitHost("::11888", "::11888", -1));
    BOOST_CHECK(TestSplitHost(":11888", "", 11888));
    BOOST_CHECK(TestSplitHost("[]:11888", "", 11888));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:11888", "127.0.0.1:11888"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:11888", "[::]:11888"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
