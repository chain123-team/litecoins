...
#if defined(NDEBUG)
#error "LiteCoins cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in ults) are considered zero fee (for relaying and mining)
 * We are ~100 times smaller then ltsoin now (2015-06-23), set minRelayTxFee only 10 times higher
...
{
    RenameThread("litecoins-scriptch");
