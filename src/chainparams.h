...
// Copyright (c) 2017 The LiteCoins Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef LTSOIN_CHAINPARAMS_H
#define LTSOIN_CHAINPARAMS_H
 ...
 * LiteCoins system. There are three: the main network on which people trade goods
