...
#ifndef LTSOIN_COINS_H
#define LTSOIN_COINS_H
...
/**
    ...
    ****Note - for LiteCoins we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /**
     * Amount of litecoins coming in to a transaction
